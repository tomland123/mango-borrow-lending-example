...
import { getWalletTokenInfo } from "mango-borrow-lending-client";
...
export const WalletProvider = ({ children }) => {
  const selectedProviderUrl = DEFAULT_PROVIDER.url;
  ...
  const fetchWalletBalances = async (connection) => {
    if (wallet?.publicKey && connected) {
      ...
      setBalances(ownedTokenAccounts);
    }
  };
  ...
  useEffect(() => {
    ...
    wallet.on("disconnect", () => {
      console.log(wallet, "what happened");
      setConnected(false);
